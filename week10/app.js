...
function updateAndRender() {
    ...
    sphereGeometryList = sphereGeometryList.sort(function(a,b) {
        var one = a.getPosition()
        var two = b.getPosition()
        var oneLength = one.subtract(camPos).length()
        var twoLength = two.subtract(camPos).length()
        // var oneLength = one.fromTo(one, camPos).length()
        // var twoLength = two.fromTo(two, camPos).length()
