function OrbitCamera (input) {
	...
	this.getPosition = function() {
		...
		converter = this.cameraWorldMatrix.clone()
		return new Vector4(converter.getElement(0,3), converter.getElement(1,3), converter.getElement(2,3), converter.getElement(3,3));
	}
