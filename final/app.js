...
function createScene() {
	...
	earth.sky.geometry = new WebGLGeometryJSON(gl, phongShaderProgram);
	earth.sky.geometry.create(loadedAssets.sphere, loadedAssets.earthSky);
	...
	let earthSkyScale = new Matrix4().makeScale(0.031, 0.031, 0.031)
	...
	var earthTranslation = new Matrix4().makeTranslation(-15, 0, 0)

	var mercuryTranslation = new Matrix4().makeTranslation(-8, 0, 0)
	var venusTranslation = new Matrix4().makeTranslation(-11, 0, 0)
	var marsTranslation = new Matrix4().makeTranslation(-20, 0, 0)
	var jupiterTranslation = new Matrix4().makeTranslation(-25, 0, 0)
	var saturnTranslation = new Matrix4().makeTranslation(-31.5, 0, 0)
	var uranusTranslation = new Matrix4().makeTranslation(-37, 0, 0)
	var neptuneTranslation = new Matrix4().makeTranslation(-42, 0, 0)
	...
	earth.sky.geometry.worldMatrix.multiply(earthTranslation).multiply(earthSkyScale);
}
...
function updateAndRender() {
	...
	earth.sky.geometry.render(camera, projectionMatrix, phongShaderProgram);
