...
function createScene() {
    ...
    let groundRotation = new Matrix4().makeRotationX(90);
    let groundTranslation = new Matrix4().makeTranslation(0, -1, 0);
    let groundScale = new Matrix4().makeScale(10, 1, 10);
    groundGeometry.worldMatrix.multiply(groundScale).multiply(groundTranslation).multiply(groundRotation);
    ...
    let sphereScale = new Matrix4().makeScale(0.01, 0.01, 0.01)
    let sphereTrans = new Matrix4().makeTranslation(0, 0, -5)
    sphereGeometry.worldMatrix.multiply(sphereTrans).multiply(sphereScale)
}
